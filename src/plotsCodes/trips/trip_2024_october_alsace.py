...
START = datetime(2024, 10, 3, 0, 0, 0, tzinfo=PARIS_TZ)
...
def plot_october_alsace_2024(data: TrainStatsData, mapbox_style: MapboxStyle):
    ...
    for trip in tqdm(trip_list, ncols=150, desc="October Lausanne 2024"):
