...
def plot_scandinavia_2024(data: TrainStatsData, mapbox_style: MapboxStyle):
    ...
    ax[0].set(
        title="2024 Scandinavia Interrail Trip",
    )
    plt.tight_layout()
    ...
    finish_map(fig, ax, "2024_scandinavia", colorbar=cbar, show=False)


def plot_scandinavia_2024_portrait(data: TrainStatsData, mapbox_style: MapboxStyle):
    # Setup map boundaries
    lon_min = -2.4
    lon_max = 19.4
    lat_min = 38.6
